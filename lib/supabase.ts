...
// const supabaseUrl = "https://xffwbsumtroatjknmisd.supabase.co";
// const supabaseAnonKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InhmZndic3VtdHJvYXRqa25taXNkIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDI0ODMzOTUsImV4cCI6MjA1ODA1OTM5NX0.CsWh3zs-Eerb_B8kkA9hoOPudEeTkObgvxLq5T7jke0";
...
//     console.log('Attempting to store data with:', { id, qrData, pinHash, created_at, expiresAt });
